...
* Atributo Composto: nome do atributo e lista de sub-atributos entre parênteses.
...
* As associações são representados pelo seu nome, a lista de entidades que nela participam e os seus atributos. 
* Normalmente usa-se um verbo e tenta-se que este faça sentido ao ser lido pela ordem
...
![Exemplo Assosiação](.idea/Images/associação.svg)
...
![exemplo redundancia](.idea/Images/redundancia.svg)
...
![exemplo dependencias](.idea/Images/dependencias.svg)
...
![exemplo 1FN](.idea/Images/1FN.svg)
...
![exemplo 1FN](.idea/Images/2FN.svg)
...
![exemplo 1FN](.idea/Images/3FN.svg)
