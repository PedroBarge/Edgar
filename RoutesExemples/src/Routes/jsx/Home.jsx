...
function Home() {
  return (
    <>
      <h2>Our Mission</h2>
      <p>
        At Unique Cats Store, our mission is to provide cat lovers with the most
        unique and extraordinary feline companions.
      </p>
      <p>
        We believe that every cat deserves a loving home, and we strive to match
        each cat with the perfect owner.
      </p>
      <h2>Location</h2>
